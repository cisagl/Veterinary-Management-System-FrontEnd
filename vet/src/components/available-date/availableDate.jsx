...
const AvailableDate = () => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post(`${import.meta.env.VITE_APP_BASE_URL}/v1/available-dates/save`, formData)
      .then(response => {
        fetchAvailableDates();
        setFormData({
          doctor: '',
  ...
  const handleUpdateSubmit = (e) => {
    e.preventDefault();
    axios.put(`${import.meta.env.VITE_APP_BASE_URL}/v1/available-dates/update/${selectedAvailableDateId}`, updateFormData)
      .then(response => {
        fetchAvailableDates();
        setUpdateFormData({  
          doctor: '',
